...
Source0  : https://download.kde.org/stable/plasma/5.16.1/kgamma5-5.16.1.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.16.1/kgamma5-5.16.1.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1560879315
mkdir -p clr-build
pushd clr-build
