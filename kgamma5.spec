...
Source0  : https://download.kde.org/stable/plasma/5.26.5/kgamma5-5.26.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.5/kgamma5-5.26.5.tar.xz.sig
...
%prep
%setup -q -n kgamma5-5.26.5
cd %{_builddir}/kgamma5-5.26.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673308263
mkdir -p clr-build
pushd clr-build
