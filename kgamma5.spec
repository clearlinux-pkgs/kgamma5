...
Version  : 5.25.3
Release  : 67
URL      : https://download.kde.org/stable/plasma/5.25.3/kgamma5-5.25.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.25.3/kgamma5-5.25.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.25.3/kgamma5-5.25.3.tar.xz.sig
...
%prep
%setup -q -n kgamma5-5.25.3
cd %{_builddir}/kgamma5-5.25.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657639924
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kgamma5-5.25.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kgamma5/e712eadfab0d2357c0f50f599ef35ee0d87534cb
pushd clr-build
%make_install
popd
%find_lang kcmkgamma
