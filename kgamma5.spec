...
Version  : 5.27.2
Release  : 79
URL      : https://download.kde.org/stable/plasma/5.27.2/kgamma5-5.27.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.2/kgamma5-5.27.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.2/kgamma5-5.27.2.tar.xz.sig
...
%prep
%setup -q -n kgamma5-5.27.2
cd %{_builddir}/kgamma5-5.27.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677603784
mkdir -p clr-build
pushd clr-build
