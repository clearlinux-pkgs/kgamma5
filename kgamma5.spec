...
Version  : 5.27.4
Release  : 81
URL      : https://download.kde.org/stable/plasma/5.27.4/kgamma5-5.27.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.4/kgamma5-5.27.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.4/kgamma5-5.27.4.tar.xz.sig
...
%prep
%setup -q -n kgamma5-5.27.4
cd %{_builddir}/kgamma5-5.27.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680717652
mkdir -p clr-build
pushd clr-build
