...
Version  : 5.14.0
Release  : 3
URL      : https://download.kde.org/stable/plasma/5.14.0/kgamma5-5.14.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.0/kgamma5-5.14.0.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.0/kgamma5-5.14.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1539110229
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
