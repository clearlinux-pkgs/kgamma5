...
Version  : 5.23.3
Release  : 55
URL      : https://download.kde.org/stable/plasma/5.23.3/kgamma5-5.23.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.23.3/kgamma5-5.23.3.tar.xz
...
%prep
%setup -q -n kgamma5-5.23.3
cd %{_builddir}/kgamma5-5.23.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636498162
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kgamma5-5.23.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kgamma5/e712eadfab0d2357c0f50f599ef35ee0d87534cb
pushd clr-build
%make_install
popd
%find_lang kcmkgamma
