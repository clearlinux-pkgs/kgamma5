...
Version  : 5.13.5
Release  : 2
URL      : https://download.kde.org/stable/plasma/5.13.5/kgamma5-5.13.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.13.5/kgamma5-5.13.5.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.13.5/kgamma5-5.13.5.tar.xz.sig
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: kgamma5-lib
Requires: kgamma5-license
Requires: kgamma5-data
Requires: kgamma5-locales
...
export LANG=C
export SOURCE_DATE_EPOCH=1536086966
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1536086966
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/kgamma5
cp COPYING %{buildroot}/usr/share/doc/kgamma5/COPYING
pushd clr-build
%make_install
popd
%find_lang kcmkgamma
