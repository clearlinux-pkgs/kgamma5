...
Version  : 5.23.4
Release  : 56
URL      : https://download.kde.org/stable/plasma/5.23.4/kgamma5-5.23.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.23.4/kgamma5-5.23.4.tar.xz
...
%prep
%setup -q -n kgamma5-5.23.4
cd %{_builddir}/kgamma5-5.23.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638358440
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kgamma5-5.23.4/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kgamma5/e712eadfab0d2357c0f50f599ef35ee0d87534cb
pushd clr-build
%make_install
popd
%find_lang kcmkgamma
