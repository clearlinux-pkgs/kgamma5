...
Version  : 5.25.2
Release  : 66
URL      : https://download.kde.org/stable/plasma/5.25.2/kgamma5-5.25.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.25.2/kgamma5-5.25.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.25.2/kgamma5-5.25.2.tar.xz.sig
...
%prep
%setup -q -n kgamma5-5.25.2
cd %{_builddir}/kgamma5-5.25.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656447173
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kgamma5-5.25.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kgamma5/e712eadfab0d2357c0f50f599ef35ee0d87534cb
pushd clr-build
%make_install
popd
%find_lang kcmkgamma
