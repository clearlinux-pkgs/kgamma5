...
Source0  : https://download.kde.org/stable/plasma/5.27.8/kgamma5-5.27.8.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.8/kgamma5-5.27.8.tar.xz.sig
...
%prep
%setup -q -n kgamma5-5.27.8
cd %{_builddir}/kgamma5-5.27.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694543912
mkdir -p clr-build
pushd clr-build
