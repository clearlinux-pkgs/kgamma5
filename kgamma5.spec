...
Source0  : https://download.kde.org/stable/plasma/5.14.4/kgamma5-5.14.4.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.4/kgamma5-5.14.4.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1543392645
mkdir -p clr-build
pushd clr-build
%cmake ..
