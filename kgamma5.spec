...
Source0  : https://download.kde.org/stable/plasma/5.24.4/kgamma5-5.24.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.24.4/kgamma5-5.24.4.tar.xz.sig
...
%prep
%setup -q -n kgamma5-5.24.4
cd %{_builddir}/kgamma5-5.24.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648659196
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kgamma5-5.24.4/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kgamma5/e712eadfab0d2357c0f50f599ef35ee0d87534cb
pushd clr-build
%make_install
popd
%find_lang kcmkgamma
